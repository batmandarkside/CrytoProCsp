...
function cryptoProPlugin() {
  ...
  function getLastError(exception) {
    if (isNativeMessageSupported() || isIE() || isIOS()) {
      return (0, _utils.GetMessageFromException)(exception);
    }
  ...
  function plugin_loaded_error(msg) {
    ...
    if (typeof msg == 'undefined' || (typeof msg === 'undefined' ? 'undefined' : _typeof(msg)) == 'object') {
  ...
  console.log('%c cadesplugin_api.js JSModuleVersion === ' + cadesplugin.JSModuleVersion, 'background: #222; color: #bada55');

  return {
    checkPluginWorking: check_plugin_working,
    cadespluginVersion: cadesplugin.JSModuleVersion
  };
};
